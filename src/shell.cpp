...
void Shell::selectedShellOption(){
    ...
    else if(str == "queueschell") option = 4;
    else if(str == "execute"    ) option = 5;
    else if(str == "kill -9"    ) option = 6;
    else if(str == "exit"       ) option = 7;
...
void Shell::helpCommand(){
    ...
    cout<<"-> diskinfo\t -> Detalha qual e quantos blocos estão alocados em disco.\n"<<endl;
